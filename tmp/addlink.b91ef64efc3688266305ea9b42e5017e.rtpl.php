        ...
        <div>
          ...
          <div>
            <input type="text" name="tags" id="tags" class="lf_input"
                   data-list="<?php $counter1=-1; if( isset($tags) && is_array($tags) && sizeof($tags) ) foreach( $tags as $key1 => $value1 ){ $counter1++; ?><?php echo escape( $key1 );?>, <?php } ?>" data-multiple data-autofirst autocomplete="off">
          </div>
