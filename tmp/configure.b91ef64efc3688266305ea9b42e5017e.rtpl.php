...
<form method="POST" action="<?php echo $base_path;?>/admin/configure" name="configform" id="configform">
  <div class="pure-g">
    ...
    <div class="pure-u-lg-3-4 pure-u-22-24 page-form page-form-complete">
        ...
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-1">
          <div class="form-label">
            <label for="titleLink">
              ...
              <span class="label-desc"><?php echo t( 'Default value' );?>: <?php echo $base_path;?>/</span>
            </label>
          </div>
        </div>
      ...
      <div class="pure-g">
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-1">
          <div class="form-label">
            <label for="titleLink">
              <span class="label-name"><?php echo t( 'Themes' );?></span>
            </label>
          </div>
        </div>
        <div class="pure-u-lg-<?php echo $ratioInput;?> pure-u-1">
        ...
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-1">
          <div class="form-label">
            <label for="formatter">
              <span class="label-name"><?php echo t( 'Description formatter' );?></span>
            </label>
          </div>
        </div>
        <div class="pure-u-lg-<?php echo $ratioInput;?> pure-u-1">
          <div class="form-input">
            <select name="formatter" id="formatter" class="align">
              <?php $counter1=-1; if( isset($formatter_available) && is_array($formatter_available) && sizeof($formatter_available) ) foreach( $formatter_available as $key1 => $value1 ){ $counter1++; ?>

                <option value="<?php echo $value1;?>"
                  <?php if( $value1===$formatter ){ ?>
        ...
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-<?php echo $ratioLabelMobile;?>">
          <div class="form-label">
            <label for="retrieveDescription">
              <span class="label-name"><?php echo t( 'Automatically retrieve description for new bookmarks' );?></span><br>
              <span class="label-desc"><?php echo t( 'Shaarli will try to retrieve the description from meta HTML headers' );?></span>
            </label>
          </div>
        </div>
        <div class="pure-u-lg-<?php echo $ratioInput;?> pure-u-<?php echo $ratioInputMobile;?>">
          <div class="form-input">
            <input type="checkbox" name="retrieveDescription" id="retrieveDescription"
                 <?php if( $retrieve_description ){ ?>checked<?php } ?>/>
          </div>
        </div>
      </div>
      <div class="pure-g">
      ...
      <div class="pure-g">
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-1">
          <div class="form-label">
            <label for="apiSecret">
              <span class="label-name"><?php echo t( 'REST API secret' );?></span><br>
            </label>
          </div>
        </div>
        <div class="pure-u-lg-<?php echo $ratioLabel;?> pure-u-1">
            ...
            <label for="enableThumbnails">
              ...
              <span class="label-desc">
                ...
                <?php }elseif( $thumbnails_enabled ){ ?>
                  ...
                  <a href="<?php echo $base_path;?>/admin/thumbnails"><?php echo t( 'Synchronize thumbnails' );?></a>
                <?php } ?>
