...
<main id="content" class="container" role="main">
  <div id="search" class="subheader-form searchform-block header-search">
    <form method="GET" class="pure-form searchform" name="searchform" action="<?php echo $base_path;?>/">
      ...
      data-list="<?php $counter1=-1; if( isset($tags) && is_array($tags) && sizeof($tags) ) foreach( $tags as $key1 => $value1 ){ $counter1++; ?><?php echo escape( $key1 );?>, <?php } ?>"
      >
          ...
          <div class="pure-u-1">
            <span>
              <input
                ...
                autocomplete="off" data-multiple data-autofirst data-minChars="1"
                data-list="<?php $counter2=-1; if( isset($tags) && is_array($tags) && sizeof($tags) ) foreach( $tags as $key2 => $value2 ){ $counter2++; ?><?php echo escape( $key2 );?>, <?php } ?>"
              >
...
<?php if( !empty($global_successes) ){ ?>
  ...
  {php}
    // check if there is at least one non-empty trimmed success message
    $hasSuccess = false;
    foreach($global_successes as $msg) {
